#
#  Be sure to run `pod spec lint PPTextField.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "PPAbner" => "chinesemanbobo@163.com" }
  # Or just: spec.author    = "PPAbner"
  # spec.authors            = { "PPAbner" => "chinesemanbobo@163.com" }
  # spec.social_media_url   = "https://twitter.com/PPAbner"
  ...
  spec.source       = { :git => "https://github.com/PPAbner/PPTextField.git", :tag => "#{spec.version}" }
